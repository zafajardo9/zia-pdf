            ...
            {!downloadUrl ? (
              <>
                <div className="space-y-4">
                  <div className="text-center py-2 px-4 bg-gray-50 dark:bg-black rounded-lg border border-gray-100 dark:border-white/5">
                ...
                {isProcessing && (
                  <div className="space-y-3">
                    ...
                    <p className="text-[10px] text-center font-semibold text-gray-400 uppercase tracking-widest animate-pulse">Extracting High-Res Assets...</p>
                  </div>
                )}
              </>
            ) : (
