    ...
    <div className="min-h-screen bg-[#FAFAFA] dark:bg-black text-gray-900 dark:text-zinc-100 selection:bg-rose-500 selection:text-white pb-24">
        ...
        <div className="bg-rose-500 text-white rounded-[2.5rem] p-8 md:p-12 flex flex-col md:flex-row items-center gap-10 relative overflow-hidden shadow-xl shadow-rose-500/20">
           ...
           <div className="flex-1 text-center md:text-left relative z-10">
              ...
              <div className="flex flex-wrap justify-center md:justify-start gap-3">
                 <a href="https://github.com/zafajardo9/PaperKnife" target="_blank" className="px-8 py-3.5 bg-white text-rose-600 rounded-2xl font-black uppercase tracking-widest text-[10px] hover:scale-105 transition-transform shadow-lg flex items-center gap-2">
      ...
      <section className="max-w-4xl mx-auto px-6 text-center border-t border-gray-100 dark:border-zinc-900 pt-16">
        <div className="flex flex-wrap justify-center gap-8 mb-12">
           <a href="https://github.com/zafajardo9/PaperKnife" target="_blank" className="flex items-center gap-2.5 text-[10px] font-black uppercase tracking-widest text-gray-400 hover:text-rose-500 transition-colors group">
        ...
        <div className="opacity-20 hover:opacity-50 transition-opacity duration-700">
          ...
          <p className="text-[9px] font-black uppercase tracking-[0.6em] text-gray-400">Zackery Alline Fajardo</p>
        </div>
      </section>
    ...
    <NativeToolLayout title="Protocol" description="System Internals" actions={null}>
      <div className="px-4 pb-32 animate-in fade-in slide-in-from-bottom-4 duration-700 space-y-4">
        ...
        <div className="bg-rose-500 text-white rounded-[2rem] p-6 relative overflow-hidden shadow-xl shadow-rose-500/20">
           ...
           <div className="relative z-10">
              ...
              <div className="grid grid-cols-2 gap-3">
                 <a href="https://github.com/zafajardo9/PaperKnife" target="_blank" className="flex items-center justify-center gap-2 py-3 bg-white text-rose-600 rounded-xl font-black uppercase text-[9px] tracking-widest shadow-sm active:scale-95 transition-transform">
                    Source Code
                 </a>
        ...
        <div className="grid grid-cols-1 gap-2 pt-2">
          <a href="https://github.com/zafajardo9/PaperKnife" target="_blank" className="flex items-center justify-between p-5 bg-white dark:bg-zinc-900 border border-gray-100 dark:border-white/5 rounded-[2rem] active:scale-[0.98] transition-all">
        ...
        <p className="text-[8px] font-black uppercase text-center text-gray-400 tracking-[0.5em] pt-8 pb-4">Handcrafted by Zackery Alline Fajardo</p>
      </div>
    </NativeToolLayout>
  )
}
