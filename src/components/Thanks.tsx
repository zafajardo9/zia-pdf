      ...
      <div className="grid grid-cols-1 gap-4 mb-12">
        ...
        <div className="p-10 bg-zinc-900 text-white rounded-[2.5rem] border border-white/10 flex flex-col md:flex-row items-center gap-10 shadow-xl relative overflow-hidden group">
          ...
          <div className="flex-1 text-center md:text-left relative z-10">
            ...
            <a href="https://github.com/zafajardo9/PaperKnife" target="_blank" className="inline-flex items-center gap-3 px-8 py-3.5 bg-white text-rose-600 rounded-2xl font-black uppercase tracking-widest text-[10px] hover:scale-105 transition-transform shadow-lg">
